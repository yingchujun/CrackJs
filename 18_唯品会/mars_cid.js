...
window.location = {
    "ancestorOrigins": {},
    "href": "https://category.vip.com/suggest.php",
...
Mar.getOSVersion = function() {
    ...
    var b, c, d, e, f, g = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36 Edg/121.0.0.0', h = {
        os: "",
        ver: ""
    };
    return b = g.match(/\(([^)]*)\)/),
...
a.nav = escape('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36 Edg/121.0.0.0'.toLowerCase()),
a.ce = navigator.cookieEnabled ? 1 : 0,
a.title = document.domain.indexOf("vipglobal.hk") > -1 ? encodeURIComponent(document.title) : escape(document.title)
...
Mar.Util = {
    ...
    getDomain: function() {
        ...
        return a = b.indexOf("vipshop.com") !== -1 ? "vipshop.com" : b.indexOf("appvipshop.com") !== -1 ? "appvipshop.com" : b.indexOf("vipglobal.hk") !== -1 ? "vipglobal.hk" : b.indexOf("vpal.com") !== -1 ? "vpal.com" : b.indexOf("vip.vip.com") !== -1 ? "vip.vip.com" : "vip.com"
    },
    parseURL: function(a) {
    ...
    isWXLite: function() {
        var a = navigator && navigator.userAgent || ""
          , b = "miniprogram" === window.__wxjs_environment && !window.__qqjs_environment || /MicroMessenger/i.test(a) && /miniProgram/.test(a);
        return b && !window.mars_var && window.T0 && (window.mars_var = {
            stream_id: window.T0
        }),
        b
    },
    isAlipayLite: function() {
        var a = navigator && navigator.userAgent || ""
          , b = /AliApp/i.test(a) && /MiniProgram/i.test(a);
        return b && !window.mars_var && window.T0 && (window.mars_var = {
            stream_id: window.T0
        }),
        b
...
function mars_cid() {
    return  Mar.Util.encryptCid(Mar.Util.pad((new Date).getTime(), 13) + "_" + Mar.Random.rand())
}
